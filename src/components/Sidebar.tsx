...
const MessageIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>;
...
const MedicalIcon = (props: React.SVGProps<SVGSVGElement>) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20a8 8 0 0 0 8-8 8 8 0 0 0-8-8 8 8 0 0 0-8 8 8 8 0 0 0 8 8z"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>;
...
const NAV_ITEMS: NavItem[] = [
    { href: '/dashboard', label: 'Dashboard', icon: HomeIcon, roles: Object.values(Role) as Role[] },
    { href: '/dashboard/documentos', label: 'Documentos', icon: FileIcon, roles: Object.values(Role) as Role[] },
    { href: '/dashboard/solicitudes', label: 'Gestión Solicitudes', icon: BriefcaseIcon, roles: Object.values(Role) as Role[] },
    { href: '/dashboard/comunicados', label: 'Comunicados', icon: MessageIcon, roles: Object.values(Role) as Role[] },
    { href: '/dashboard/licencias', label: 'Gestión Licencias', icon: MedicalIcon, roles: [Role.SUBDIRECCION] },
    { href: '/dashboard/admin', label: 'Admin Usuarios', icon: UserIcon, roles: [Role.ADMIN, Role.DIRECCION] },
];
...
export default function Sidebar({ userRole, onLogout }: Readonly<SidebarProps>) {
